	...
	<tr>
        ...
        <td>
			<select class="form-control" name="regimen" style="min-width:100px; max-width: 100px;">
                <option value="">---</option>
                @foreach($regimen as $regim)
                <option value="{{$regim->OID}}">{{$regim->Code}}</option>
				@endforeach
            </select>
		</td>
    </tr>
	...
	<tr>
        ...
        <td>
			<select class="form-control" name="artsource" style="min-width:100px; max-width: 100px;">
                ...
                <option value="{{$fundingsource->OID}}">{{$fundingsource->Code.' - '.$fundingsource->Name}}</option>
                @endforeach
