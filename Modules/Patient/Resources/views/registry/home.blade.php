...
@section('title') OpenICEA @endsection
@section('heading')
...
@section('content')
 ...
 @canany(['view clients','edit clients','delete clients','manage encounters','manage prescriptions','make lab requests'])
	...
	<div style="width:100%; height: auto; margin:0 auto">
		...
		<div style="width:73%; height: auto; display: inline-block; margin:0 auto; vertical-align: top; margin-bottom:20px;">
			...
			<div style="margin-top:20px;padding:10px !important; border: solid 1px #ccc;">
				@include('patient::registry.charts')
			</div>
		</div>
		<!-- Div 1 -->
