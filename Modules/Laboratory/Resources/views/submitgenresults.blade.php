        ...
        <!-- client information -->
            ...
            <table class="prescription_table" style="margin-bottom:5px;max-width: 400px;">
                ...
                <tr>
                    ...
                    @elseif(str_contains($sample->labsample->Name, 'Urine'))
                        <td width="20" style="border-bottom: solid 1px #ccc; border-right: solid 1px #ccc;">
                            <label for="{{$sample->labsample->OID}}" style="cursor: pointer;">{{$sample->labsample->Name }}</label>
                        </td>
                        <td width="10" style="border-bottom: solid 1px #ccc; border-right: solid 1px #d6d4d0; cursor: pointer;">
                            <input type="checkbox" name="urine" value="1" id="{{$sample->labsample->OID}}" style="width:auto; margin-right:5px;" />
                        </td>
                    @elseif(str_contains($sample->labsample->Name, 'Sputum'))
                        <td width="20" style="border-bottom: solid 1px #ccc; border-right: solid 1px #ccc;">
                            <label for="{{$sample->labsample->OID}}" style="cursor: pointer;">{{$sample->labsample->Name }}</label>
                        </td>
                        <td width="10" style="border-bottom: solid 1px #ccc; border-right: solid 1px #d6d4d0; cursor: pointer;">
                            <input type="checkbox" name="sputum" value="1" id="{{$sample->labsample->OID}}" style="width:auto; margin-right:5px;" />
                        </td>
                    @else
                        <td width="20" style="border-bottom: solid 1px #ccc; border-right: solid 1px #ccc;">
                            <label for="{{$sample->labsample->OID}}" style="cursor: pointer;">{{$sample->labsample->Name }}</label>
