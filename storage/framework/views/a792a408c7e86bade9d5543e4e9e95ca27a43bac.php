                ...
                <tr>
                    <td>
                        <div class="pretty p-default">
                            <input type="checkbox" name="reasons[]" value="<?php echo e($appointmenttype->OID); ?>"/><div class="state p-primary"><label><?php echo e($appointmenttype->Name); ?></label></div>
                        </div>
                    </td>
                </tr>
    ...
    //date
        $(document).ready(function () {
            ...
            $('#saveappointment').on('click',function(e){
                ...
                $.ajax({
                    type: 'post',
                    url: '<?php echo e(route("saveappointment")); ?>',
                    data: form,
                    processData: false,
                    contentType: false,
...
</script><?php /**PATH C:\xampp\htdocs\OpenICEA\modules/Patient\Resources/views/registry/newappointment.blade.php ENDPATH**/ ?>