<form id="msform" class="encounterform" >
    ...
    <!--  Clinical Information -->
        ...
        <table class="prescription_table">
            <tr>
                <td>Ordered By:</td><td> <input type="text" name="provider" value="<?php echo e(Auth::user()->FirstName.' '. Auth::user()->LastName); ?>" readonly></td>
            </tr>
            <tr>
                ...
                <?php $__currentLoopData = $sampletypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sampletype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td>
                        <div class="pretty p-default">
                            <input type="checkbox" name="samples" value="<?php echo e($sampletype->OID); ?>" /><div class="state p-primary"><label><?php echo e($sampletype->Name); ?></label></div>
                        </div>
                    </td>
                    <?php if($sampletype->OID%4==0): ?>
                        <tr><td></td></tr>
                    <?php endif; ?>
    ...
    //get sample tests
        $('input[name=samples]').unbind().bind('change', function(){
            ...
            if(samples.length>0){
                $.ajax({
                    type: 'get',
                    url: '<?php echo e(route("getsampletests")); ?>',
    ...
    //save Lab Requisition
        $(document).ready(function () {   
            $('#saverequisition').unbind().bind('click', function(e){
                ...
                $.ajax({
                    type: 'post',
                    url: '<?php echo e(route("createlabrequisition")); ?>',
                    data: form,
                    processData: false,
                    contentType: false,
                    success: function(data)
...
</script><?php /**PATH C:\xampp\htdocs\OpenICEA\modules/Laboratory\Resources/views/requisitionform.blade.php ENDPATH**/ ?>