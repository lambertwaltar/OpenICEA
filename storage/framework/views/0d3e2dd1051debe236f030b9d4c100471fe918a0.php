    ...
    <form id="msform" class="encounterform" autocomplete="off">
        ...
        <div id="triage" class="tabcontent">
            ...
            <table class="prescription_table">
                ...
                <tr>
                    <td>Height:</td><td><input type="number" name="height" id="height" min="10" value='<?php echo e($lastfs->Height); ?>'></td>
                </tr>
                <tr>
    ...
    //save Triage information
        $(document).ready(function () {   
            $('#saveflowsheet').on('click', function(e){
                ...
                $.ajax({
                    type: 'post',
                    url: '<?php echo e(route("saveflowsheet")); ?>',
                    data: form,
                    processData: false,
                    contentType: false,
                    success: function(data)
                    {
                        ...
                        $('#mymodal2').on('hidden.bs.modal', function () {
                            $("#mymodal #labtablebody").load('<?php echo e(route("flowsheets",["idcno"=>""])); ?>'+$('#fidcno').val()+ ' #labtablebody');
                        });
						//clear detail
						$('#hometemp').text('');
						$('#bp').text('');
...
</script><?php /**PATH C:\xampp\htdocs\OpenICEA\modules/Patient\Resources/views/flowsheet/newflowsheet.blade.php ENDPATH**/ ?>